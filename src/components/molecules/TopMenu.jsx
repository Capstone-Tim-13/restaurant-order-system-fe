...
export default function TopMenu() {
  return (
    <div className="max-w-[1700px]">
      <div className="h-[750px] w-full bg-[#0c0c0c]">
        <div className="w-[370px] absolute ml-36 h-[630px] mt-12 [border-left:4px_dashed_#FCFCFC] [border-right:4px_dashed_#FCFCFC] [border-bottom:4px_dashed_#FCFCFC] rounded-tl-[48px] rounded-br-[48px] rounded-tr-[48px] rounded-bl-[48px]">
          <div className="bg-[#783525] text-white p-8 w-[320px] h-[580px] mt-5 ml-5 rounded-tl-[499px] rounded-br-[150px] rounded-tr-[499px] rounded-bl-[150px]">
            <img
              src={MENU_SATU}
        ...
        <div className="w-[370px] absolute  mt-12 ml-[680px] h-[630px] [border-left:4px_dashed_#FCFCFC] [border-right:4px_dashed_#FCFCFC] [border-bottom:4px_dashed_#FCFCFC] rounded-tl-[48px] rounded-br-[48px] rounded-tr-[48px] rounded-bl-[48px]">
          <div className="bg-[#783525] text-white p-8 w-[320px] h-[580px] mt-5 ml-5 rounded-tl-[499px] rounded-br-[150px] rounded-tr-[499px] rounded-bl-[150px]">
            <img
              src={MENU_DUA}
        ...
        <div className="w-[370px] absolute mt-12 ml-[1200px] h-[630px] [border-left:4px_dashed_#FCFCFC] [border-right:4px_dashed_#FCFCFC] [border-bottom:4px_dashed_#FCFCFC] rounded-tl-[48px] rounded-br-[48px] rounded-tr-[48px] rounded-bl-[48px]">
          <div className="bg-[#783525] text-white p-8 w-[320px] h-[580px] mt-5 ml-5 rounded-tl-[499px] rounded-br-[150px] rounded-tr-[499px] rounded-bl-[150px]">
            <img
              src={MENU_TIGA}
              className="w-full h-auto m-0 block max-w-[632px]"
            />
            <div class="w-full max-w-[200px] ml-8 text-center">
              <p class="text-[#fcfcfc] text-[28px] text-center font-bold">
                Fusilli Aglio Olio
              </p>
            </div>

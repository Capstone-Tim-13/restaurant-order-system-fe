...
export const CardMenu = () => (
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-20 mx-20">
    <div className="relative bottom-16 ml-10 justify-center items-center">
      <div className="bg-white text-white p-8 ml-14 w-[350px] h-[250px] rounded-[50px]">
    ...
    <div className="relative bottom-16 ml-16 justify-center items-center">
      <div className="bg-white text-white p-8 w-[350px] h-[250px] rounded-[50px]">
